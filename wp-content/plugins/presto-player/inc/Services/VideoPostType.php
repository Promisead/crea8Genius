...
class VideoPostType
{
    ...
    public function register()
    {
        ...
        add_action('init', [$this, 'registerMetaSettings']);
        ...
        add_action("manage_{$this->post_type}_posts_custom_column", [$this, 'postTypeColumnContent'], 10, 2);
        ...
        add_action('template_redirect', [$this, 'maybeRedirectTo404']);
        ...
        add_action('admin_enqueue_scripts', [$this, 'enqueueEditorToolbarScript']);

        add_filter('post_thumbnail_id', [$this, 'attachPoster'], 10, 2);

        add_filter('the_title', [$this, 'filterVideoTitle'], 10, 2);

        add_filter('rest_prepare_' . $this->post_type, [$this, 'addTitleField'], 10, 3);

        add_action('transition_post_status', [$this, 'set_post_title'], 10, 3);
    }
...
?>
    ...
    {
        ob_start();
        $thumbnail = get_the_post_thumbnail($post_ID, "", array(
...
<?php
    ...
    public function singleTemplate($template)
    {
        ...
        $theme_template = locate_template(['single-presto-media.php']);
        if ($theme_template) {
