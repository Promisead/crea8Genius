    ...
    <?php
      ...
      <div class="row">
        ...
        <div id="our-services" class="services col-lg-8 col-md-8">
          <?php if(get_theme_mod('vw_saas_services_single_post_breadcrumb',true) == 1){ ?>
          ...
          <div class="navigation">
            <?php
              ...
              the_posts_pagination( array(
                'prev_text' => __( 'Previous page', 'vw-saas-services' ),
                'next_text' => __( 'Next page', 'vw-saas-services' ),
                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-saas-services' ) . ' </span>',
              ) );
            ?>
